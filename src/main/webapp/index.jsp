   ...
   <main>
        ...
        <section id="todo">
            <div class="contenedor">
                <article class="texto">
                    <h4>Sobre Lesnuti</h4>
                    <p> Gomitas Lesnuti es mucho más que un simple emprendimiento de gomitas es el resultado de la creatividad y la determinación de dos jóvenes emprendedoras que decidieron convertir un desafío en una oportunidad durante la pandemia del COVID-19. </p>
                    <p> Lo que comenzó como un proyecto modesto en la cocina de sus hogares, rápidamente se convirtió en una empresa emergente que ofrece una amplia variedad de gomitas artesanales, elaboradas con los ingredientes más frescos y de la más alta calidad. Desde ositos de colores hasta formas divertidas y temáticas, cada dulce de Gomitas Lesnuti está cuidadosamente elaborado para brindar una experiencia de sabor única y reconfortante. </p>
            
                    <img src="https://noro.mx/wp-content/uploads/2022/06/mujer-vendiendo-edited.jpeg" alt="Imagen">
                </article>
